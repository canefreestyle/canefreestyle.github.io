...
// Function to open a random URL in the top frame
function openRandomURL() {
    ...
    document.getElementById("topFrame").src = randomURL;
}
...
document.getElementById("randomButton").addEventListener("click", function() {
    openRandomURL(); // Open a random URL in the top frame when the button is clicked
});
